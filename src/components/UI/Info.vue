<template>
	<div class="info-container" ref="infoBox" :class="containerClasses">
		...
		<div class="info-buttons">
			...
			<a href="https://github.com/KumaranPunniyakotti" target="_blank">
	...
	data: () => ({
		...
		tutorial: [
			...
			},
			{
				...
				<br>
				<small>("They are quite clearly buildings, Kumaran" - I know but I'm used to the 'wall' terminology :p)</small>`
			},
			{
			...
			},
			{
				...
				<br><br>
				You can view the source code for this project on <a href="https://github.com/KumaranPunniyakotti" target="_blank">GitHub</a>
				`
			},
		],
		tutorialIndex: 0,
		...
		attributions: {
			...
			text: `<div style="text-align: left">
				...
				And playing pubg with my friends.
				<br><br>
				...
				Source code <a href="https://github.com/KumaranPunniyakotti" target="_blank">repository</a>.
				<br><br>
